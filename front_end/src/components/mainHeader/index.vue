  ...
  <div class="header-container">
    <div class="inner container">
      <div class="header-left-container">
        ...
        <div class="search">
          <div class="search-input" ref="search-input">
            <el-input placeholder="请输入内容" v-model="searchContent" class="input">
              <el-button slot="append" icon="el-icon-search" type="primary" size="mini"></el-button>
            </el-input>
          </div>
        </div>
      </div>
